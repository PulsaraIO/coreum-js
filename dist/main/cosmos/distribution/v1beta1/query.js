...
exports.QueryValidatorDistributionInfoResponse = {
    ...
    fromPartial(object) {
        ...
        message.selfBondRewards =
            ((_b = object.selfBondRewards) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        message.commission =
            ((_c = object.commission) === null || _c === void 0 ? void 0 : _c.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        return message;
    },
};
