...
exports.MsgMint = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.data !== undefined) {
            any_1.Any.encode(message.data, writer.uint32(50).fork()).join();
        }
...
exports.MsgUpdateData = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.items) {
            types_1.DataDynamicIndexedItem.encode(v, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.MsgUpdateData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseMsgUpdateData();
        ...
        message.id = (_c = object.id) !== null && _c !== void 0 ? _c : "";
        message.items =
            ((_d = object.items) === null || _d === void 0 ? void 0 : _d.map((e) => types_1.DataDynamicIndexedItem.fromPartial(e))) || [];
        return message;
    },
};
...
exports.MsgClassFreeze = {
    ...
    create(base) {
        return exports.MsgClassFreeze.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseMsgClassFreeze();
...
exports.MsgClassUnfreeze = {
    ...
    create(base) {
        return exports.MsgClassUnfreeze.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseMsgClassUnfreeze();
...
exports.MsgAddToClassWhitelist = {
    ...
    create(base) {
        return exports.MsgAddToClassWhitelist.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseMsgAddToClassWhitelist();
...
exports.MsgRemoveFromClassWhitelist = {
    ...
    create(base) {
        return exports.MsgRemoveFromClassWhitelist.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseMsgRemoveFromClassWhitelist();
