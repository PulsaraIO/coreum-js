...
export const QuerySmartContractStateRequest: MessageFns<QuerySmartContractStateRequest> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<QuerySmartContractStateRequest>, I>
    >(object: I): QuerySmartContractStateRequest {
      const message = createBaseQuerySmartContractStateRequest();
      message.address = object.address ?? "";
      message.queryData = object.queryData ?? new Uint8Array(0);
      return message;
...
export const QuerySmartContractStateResponse: MessageFns<QuerySmartContractStateResponse> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<QuerySmartContractStateResponse>, I>
    >(object: I): QuerySmartContractStateResponse {
      const message = createBaseQuerySmartContractStateResponse();
      message.data = object.data ?? new Uint8Array(0);
      return message;
    },
  ...
  fromJSON(object: any): QueryPinnedCodesResponse {
    return {
      codeIds: globalThis.Array.isArray(object?.codeIds)
        ? object.codeIds.map((e: any) => globalThis.Number(e))
        : [],
      pagination: isSet(object.pagination)
        ? PageResponse.fromJSON(object.pagination)
        : undefined,
...
export const QueryContractsByCreatorRequest: MessageFns<QueryContractsByCreatorRequest> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<QueryContractsByCreatorRequest>, I>
    >(object: I): QueryContractsByCreatorRequest {
      const message = createBaseQueryContractsByCreatorRequest();
...
export const QueryContractsByCreatorResponse: MessageFns<QueryContractsByCreatorResponse> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<QueryContractsByCreatorResponse>, I>
    >(object: I): QueryContractsByCreatorResponse {
      const message = createBaseQueryContractsByCreatorResponse();
