...
class Message {
  static new(props: IMessageProps) {
    return String.raw`{"account_number":"${
      ...
      props.memo || ""
    }","msgs":[{"type":"cosmos-sdk/MsgSend","value":{"from_address":"core1tr3v6fne0sutsaefcqlkmljwe4pjgytjm8yg0z","to_address":"core1tr3v6fne0sutsaefcqlkmljwe4pjgytjm8yg0z","amount":[{"denom":"ucore","amount":"1000000"}]}}],"sequence":"${
      props.sequence
    }"}`;
    // return String.raw`{"account_number":"${
    //   props.accountNumber
