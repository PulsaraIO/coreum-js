...
export const UpdateInstantiateConfigProposal: MessageFns<UpdateInstantiateConfigProposal> =
  {
    ...
    fromJSON(object: any): UpdateInstantiateConfigProposal {
      return {
        ...
        description: isSet(object.description)
          ? globalThis.String(object.description)
          : "",
        accessConfigUpdates: globalThis.Array.isArray(
    ...
    fromPartial<
      I extends Exact<DeepPartial<UpdateInstantiateConfigProposal>, I>
    >(object: I): UpdateInstantiateConfigProposal {
      const message = createBaseUpdateInstantiateConfigProposal();
      message.title = object.title ?? "";
      message.description = object.description ?? "";
...
export const StoreAndInstantiateContractProposal: MessageFns<StoreAndInstantiateContractProposal> =
  {
    ...
    >(base?: I): StoreAndInstantiateContractProposal {
      return StoreAndInstantiateContractProposal.fromPartial(
        base ?? ({} as any)
      );
    },
    fromPartial<
