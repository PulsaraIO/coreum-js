...
export const MsgPlaceOrder: MessageFns<MsgPlaceOrder> = {
  ...
  create<I extends Exact<DeepPartial<MsgPlaceOrder>, I>>(
    base?: I
  ): MsgPlaceOrder {
    return MsgPlaceOrder.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgPlaceOrder>, I>>(
    object: I
  ): MsgPlaceOrder {
    const message = createBaseMsgPlaceOrder();
...
export const MsgCancelOrder: MessageFns<MsgCancelOrder> = {
  ...
  create<I extends Exact<DeepPartial<MsgCancelOrder>, I>>(
    base?: I
  ): MsgCancelOrder {
...
export const MsgCancelOrdersByDenom: MessageFns<MsgCancelOrdersByDenom> = {
  ...
  create<I extends Exact<DeepPartial<MsgCancelOrdersByDenom>, I>>(
    base?: I
  ): MsgCancelOrdersByDenom {
    return MsgCancelOrdersByDenom.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgCancelOrdersByDenom>, I>>(
    object: I
  ): MsgCancelOrdersByDenom {
    const message = createBaseMsgCancelOrdersByDenom();
    message.sender = object.sender ?? "";
