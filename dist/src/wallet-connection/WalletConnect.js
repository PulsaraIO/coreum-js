...
function WalletConnect(props) {
    ...
    return (_jsx(ChainProvider, Object.assign({ chains: [coreumChain], assetLists: [coreumAsset], wallets: [...kplrWallets, ...leapWallets, ...cosmosWallets], walletModal: WalletModal }, { children: children })));
}
