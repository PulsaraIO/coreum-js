...
exports.QueryOrderBooksResponse = {
    ...
    fromPartial(object) {
        ...
        const message = createBaseQueryOrderBooksResponse();
        message.orderBooks =
            ((_a = object.orderBooks) === null || _a === void 0 ? void 0 : _a.map((e) => order_1.OrderBookData.fromPartial(e))) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
...
exports.QueryOrderBookOrdersRequest = {
    ...
    create(base) {
        return exports.QueryOrderBookOrdersRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseQueryOrderBookOrdersRequest();
...
exports.QueryOrderBookOrdersResponse = {
    ...
    create(base) {
        return exports.QueryOrderBookOrdersResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryOrderBookOrdersResponse();
...
exports.QueryAccountDenomOrdersCountRequest = {
    ...
    create(base) {
        return exports.QueryAccountDenomOrdersCountRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryAccountDenomOrdersCountRequest();
...
exports.QueryAccountDenomOrdersCountResponse = {
    ...
    create(base) {
        return exports.QueryAccountDenomOrdersCountResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAccountDenomOrdersCountResponse();
