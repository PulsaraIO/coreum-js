...
export const GenesisState: MessageFns<GenesisState> = {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.orderBooks.push(
            OrderBookDataWithID.decode(reader, reader.uint32())
          );
          continue;
        }
        case 3: {
        ...
        case 5: {
          ...
          message.accountsDenomsOrdersCounts.push(
            AccountDenomOrdersCount.decode(reader, reader.uint32())
          );
          continue;
        }
        case 6: {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      orderSequence: isSet(object.orderSequence)
        ...
        : 0,
      accountsDenomsOrdersCounts: globalThis.Array.isArray(
        object?.accountsDenomsOrdersCounts
      )
        ? object.accountsDenomsOrdersCounts.map((e: any) =>
            AccountDenomOrdersCount.fromJSON(e)
          )
        : [],
      reservedOrderIds: globalThis.Array.isArray(object?.reservedOrderIds)
        ? object.reservedOrderIds.map((e: any) => bytesFromBase64(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.accountsDenomsOrdersCounts?.length) {
      obj.accountsDenomsOrdersCounts = message.accountsDenomsOrdersCounts.map(
        (e) => AccountDenomOrdersCount.toJSON(e)
      );
    }
    if (message.reservedOrderIds?.length) {
      obj.reservedOrderIds = message.reservedOrderIds.map((e) =>
        base64FromBytes(e)
      );
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.accountsDenomsOrdersCounts =
      object.accountsDenomsOrdersCounts?.map((e) =>
        AccountDenomOrdersCount.fromPartial(e)
      ) || [];
...
export const OrderBookDataWithID: MessageFns<OrderBookDataWithID> = {
  ...
  create<I extends Exact<DeepPartial<OrderBookDataWithID>, I>>(
    base?: I
  ): OrderBookDataWithID {
    return OrderBookDataWithID.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrderBookDataWithID>, I>>(
    object: I
  ): OrderBookDataWithID {
    const message = createBaseOrderBookDataWithID();
...
export const AccountDenomOrdersCount: MessageFns<AccountDenomOrdersCount> = {
  ...
  create<I extends Exact<DeepPartial<AccountDenomOrdersCount>, I>>(
    base?: I
  ): AccountDenomOrdersCount {
    return AccountDenomOrdersCount.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AccountDenomOrdersCount>, I>>(
    object: I
  ): AccountDenomOrdersCount {
    const message = createBaseAccountDenomOrdersCount();
