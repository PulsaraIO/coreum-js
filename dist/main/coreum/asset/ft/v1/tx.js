...
exports.MsgIssue = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.extensionSettings !== undefined) {
            exports.ExtensionIssueSettings.encode(message.extensionSettings, writer.uint32(98).fork()).join();
        }
        if (message.dexSettings !== undefined) {
            token_1.DEXSettings.encode(message.dexSettings, writer.uint32(106).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.ExtensionIssueSettings = {
    ...
    fromJSON(object) {
        return {
            ...
            funds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.funds)
    ...
    fromPartial(object) {
        ...
        message.issuanceMsg = (_d = object.issuanceMsg) !== null && _d !== void 0 ? _d : new Uint8Array(0);
        return message;
    },
};
...
exports.MsgMint = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.coin !== undefined) {
            coin_1.Coin.encode(message.coin, writer.uint32(18).fork()).join();
        }
...
exports.MsgBurn = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.coin !== undefined) {
            coin_1.Coin.encode(message.coin, writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgUpdateDEXWhitelistedDenoms = {
    ...
    fromJSON(object) {
        return {
            sender: isSet(object.sender) ? globalThis.String(object.sender) : "",
            denom: isSet(object.denom) ? globalThis.String(object.denom) : "",
            whitelistedDenoms: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.whitelistedDenoms)
    ...
    toJSON(message) {
        ...
        if ((_a = message.whitelistedDenoms) === null || _a === void 0 ? void 0 : _a.length) {
