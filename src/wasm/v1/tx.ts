...
export const MsgInstantiateContractResponse: MessageFns<MsgInstantiateContractResponse> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<MsgInstantiateContractResponse>, I>
    >(object: I): MsgInstantiateContractResponse {
      const message = createBaseMsgInstantiateContractResponse();
...
export const MsgInstantiateContract2Response: MessageFns<MsgInstantiateContract2Response> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<MsgInstantiateContract2Response>, I>
    >(object: I): MsgInstantiateContract2Response {
      const message = createBaseMsgInstantiateContract2Response();
      message.address = object.address ?? "";
      message.data = object.data ?? new Uint8Array(0);
      return message;
...
export const MsgUpdateInstantiateConfigResponse: MessageFns<MsgUpdateInstantiateConfigResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<MsgUpdateInstantiateConfigResponse>, I>>(
      ...
      return MsgUpdateInstantiateConfigResponse.fromPartial(
        base ?? ({} as any)
      );
    },
    fromPartial<
...
export const MsgStoreAndInstantiateContract: MessageFns<MsgStoreAndInstantiateContract> =
  {
    ...
    >(object: I): MsgStoreAndInstantiateContract {
      const message = createBaseMsgStoreAndInstantiateContract();
      message.authority = object.authority ?? "";
      message.wasmByteCode = object.wasmByteCode ?? new Uint8Array(0);
      message.instantiatePermission =
