...
export const EventOrderPlaced: MessageFns<EventOrderPlaced> = {
  ...
  create<I extends Exact<DeepPartial<EventOrderPlaced>, I>>(
    base?: I
  ): EventOrderPlaced {
    return EventOrderPlaced.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventOrderPlaced>, I>>(
    object: I
  ): EventOrderPlaced {
    const message = createBaseEventOrderPlaced();
...
export const EventOrderReduced: MessageFns<EventOrderReduced> = {
  ...
  create<I extends Exact<DeepPartial<EventOrderReduced>, I>>(
    base?: I
  ): EventOrderReduced {
    return EventOrderReduced.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventOrderReduced>, I>>(
    object: I
  ): EventOrderReduced {
    const message = createBaseEventOrderReduced();
    message.creator = object.creator ?? "";
