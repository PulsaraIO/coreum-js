...
export const ContractExecutionAuthorization: MessageFns<ContractExecutionAuthorization> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<ContractExecutionAuthorization>, I>
    >(object: I): ContractExecutionAuthorization {
      const message = createBaseContractExecutionAuthorization();
      message.grants =
...
export const ContractMigrationAuthorization: MessageFns<ContractMigrationAuthorization> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<ContractMigrationAuthorization>, I>
    >(object: I): ContractMigrationAuthorization {
      const message = createBaseContractMigrationAuthorization();
      message.grants =
        object.grants?.map((e) => ContractGrant.fromPartial(e)) || [];
      return message;
