...
export const QueryMinGasPriceRequest: MessageFns<QueryMinGasPriceRequest> = {
  encode(
...
export const QueryMinGasPriceResponse: MessageFns<QueryMinGasPriceResponse> = {
  encode(
    message: QueryMinGasPriceResponse,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.minGasPrice !== undefined) {
      DecCoin.encode(message.minGasPrice, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const QueryRecommendedGasPriceRequest: MessageFns<QueryRecommendedGasPriceRequest> =
  {
    encode(
    ...
    fromPartial<
      I extends Exact<DeepPartial<QueryRecommendedGasPriceRequest>, I>
    >(object: I): QueryRecommendedGasPriceRequest {
      const message = createBaseQueryRecommendedGasPriceRequest();
...
export const QueryRecommendedGasPriceResponse: MessageFns<QueryRecommendedGasPriceResponse> =
  {
    encode(
      ...
      if (message.low !== undefined) {
        DecCoin.encode(message.low, writer.uint32(10).fork()).join();
      }
      if (message.med !== undefined) {
        DecCoin.encode(message.med, writer.uint32(18).fork()).join();
      }
      if (message.high !== undefined) {
        DecCoin.encode(message.high, writer.uint32(26).fork()).join();
      }
      return writer;
    },
...
export class QueryClientImpl implements Query {
  ...
  MinGasPrice(
    ...
    return promise.then((data) =>
      QueryMinGasPriceResponse.decode(new BinaryReader(data))
    );
  }
  ...
  RecommendedGasPrice(
    ...
    return promise.then((data) =>
      QueryRecommendedGasPriceResponse.decode(new BinaryReader(data))
    );
  }
