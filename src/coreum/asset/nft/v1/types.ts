...
export const DataBytes: MessageFns<DataBytes> = {
  encode(message: DataBytes, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const DataDynamicItem: MessageFns<DataDynamicItem> = {
  encode(message: DataDynamicItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): DataDynamicItem {
    return {
      editors: globalThis.Array.isArray(object?.editors) ? object.editors.map((e: any) => dataEditorFromJSON(e)) : [],
  ...
  create<I extends Exact<DeepPartial<DataDynamicItem>, I>>(base?: I): DataDynamicItem {
    return DataDynamicItem.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DataDynamicItem>, I>>(object: I): DataDynamicItem {
    const message = createBaseDataDynamicItem();
...
export const DataDynamicIndexedItem: MessageFns<DataDynamicIndexedItem> = {
  encode(message: DataDynamicIndexedItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.index !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataDynamicIndexedItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<DataDynamicIndexedItem>, I>>(base?: I): DataDynamicIndexedItem {
    return DataDynamicIndexedItem.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DataDynamicIndexedItem>, I>>(object: I): DataDynamicIndexedItem {
    const message = createBaseDataDynamicIndexedItem();
...
export const DataDynamic: MessageFns<DataDynamic> = {
  encode(message: DataDynamic, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.items) {
      DataDynamicItem.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): DataDynamic {
    return {
      items: globalThis.Array.isArray(object?.items) ? object.items.map((e: any) => DataDynamicItem.fromJSON(e)) : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DataDynamic>, I>>(object: I): DataDynamic {
    const message = createBaseDataDynamic();
    message.items = object.items?.map((e) => DataDynamicItem.fromPartial(e)) || [];
    return message;
  },
};
