  ...
  fromJSON(object: any): SendAuthorization {
    return {
      nfts: globalThis.Array.isArray(object?.nfts)
        ? object.nfts.map((e: any) => NFTIdentifier.fromJSON(e))
        : [],
    };
  },
...
export const NFTIdentifier: MessageFns<NFTIdentifier> = {
  ...
  create<I extends Exact<DeepPartial<NFTIdentifier>, I>>(
    base?: I
  ): NFTIdentifier {
    return NFTIdentifier.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NFTIdentifier>, I>>(
    object: I
  ): NFTIdentifier {
    const message = createBaseNFTIdentifier();
