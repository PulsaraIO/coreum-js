...
export const DataDynamicItem = {
    ...
    fromJSON(object) {
        return {
            editors: globalThis.Array.isArray(object?.editors) ? object.editors.map((e) => dataEditorFromJSON(e)) : [],
...
export const DataDynamic = {
    ...
    fromJSON(object) {
        return {
            items: globalThis.Array.isArray(object?.items) ? object.items.map((e) => DataDynamicItem.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
