...
exports.EventClassFrozen = {
    ...
    create(base) {
        return exports.EventClassFrozen.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventClassFrozen();
...
exports.EventClassUnfrozen = {
    ...
    create(base) {
        return exports.EventClassUnfrozen.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventClassUnfrozen();
...
exports.EventAddedToClassWhitelist = {
    ...
    create(base) {
        return exports.EventAddedToClassWhitelist.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventAddedToClassWhitelist();
...
exports.EventRemovedFromClassWhitelist = {
    ...
    create(base) {
        return exports.EventRemovedFromClassWhitelist.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventRemovedFromClassWhitelist();
