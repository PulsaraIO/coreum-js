...
exports.Token = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.dexSettings !== undefined) {
            exports.DEXSettings.encode(message.dexSettings, writer.uint32(130).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.TokenUpgradeV1Status = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.startTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.startTime), writer.uint32(18).fork()).join();
        }
        if (message.endTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.endTime), writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.TokenUpgradeStatuses = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.v1 !== undefined) {
            exports.TokenUpgradeV1Status.encode(message.v1, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
