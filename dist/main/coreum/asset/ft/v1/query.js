...
exports.QueryTokenResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.token !== undefined) {
            token_1.Token.encode(message.token, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.QueryTokenUpgradeStatusesRequest = {
    ...
    create(base) {
        return exports.QueryTokenUpgradeStatusesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryTokenUpgradeStatusesRequest();
...
exports.QueryTokenUpgradeStatusesResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.statuses !== undefined) {
            token_1.TokenUpgradeStatuses.encode(message.statuses, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.QueryTokenUpgradeStatusesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryTokenUpgradeStatusesResponse();
        message.statuses =
...
exports.QueryBalanceResponse = {
    ...
    fromPartial(object) {
        ...
        message.whitelisted = (_b = object.whitelisted) !== null && _b !== void 0 ? _b : "";
        message.frozen = (_c = object.frozen) !== null && _c !== void 0 ? _c : "";
        message.locked = (_d = object.locked) !== null && _d !== void 0 ? _d : "";
        message.lockedInVesting = (_e = object.lockedInVesting) !== null && _e !== void 0 ? _e : "";
        message.lockedInDex = (_f = object.lockedInDex) !== null && _f !== void 0 ? _f : "";
        message.expectedToReceiveInDex = (_g = object.expectedToReceiveInDex) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
    ...
    fromJSON(object) {
        return {
            pagination: isSet(object.pagination)
                ? pagination_1.PageResponse.fromJSON(object.pagination)
                : undefined,
            balances: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.balances)
...
exports.QueryDEXSettingsRequest = {
    ...
    create(base) {
        return exports.QueryDEXSettingsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryDEXSettingsRequest();
...
exports.QueryDEXSettingsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.dexSettings !== undefined) {
            token_1.DEXSettings.encode(message.dexSettings, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.QueryDEXSettingsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryDEXSettingsResponse();
        message.dexSettings =
...
class QueryClientImpl {
    ...
    Tokens(request) {
        ...
        return promise.then((data) => exports.QueryTokensResponse.decode(new wire_1.BinaryReader(data)));
    }
    Token(request) {
        const data = exports.QueryTokenRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Token", data);
        return promise.then((data) => exports.QueryTokenResponse.decode(new wire_1.BinaryReader(data)));
    }
    TokenUpgradeStatuses(request) {
        ...
        return promise.then((data) => exports.QueryTokenUpgradeStatusesResponse.decode(new wire_1.BinaryReader(data)));
    }
    Balance(request) {
        const data = exports.QueryBalanceRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Balance", data);
        return promise.then((data) => exports.QueryBalanceResponse.decode(new wire_1.BinaryReader(data)));
    }
    FrozenBalances(request) {
        ...
        return promise.then((data) => exports.QueryFrozenBalancesResponse.decode(new wire_1.BinaryReader(data)));
    }
    FrozenBalance(request) {
        ...
        return promise.then((data) => exports.QueryFrozenBalanceResponse.decode(new wire_1.BinaryReader(data)));
    }
    WhitelistedBalances(request) {
        ...
        return promise.then((data) => exports.QueryWhitelistedBalancesResponse.decode(new wire_1.BinaryReader(data)));
    }
    WhitelistedBalance(request) {
        ...
        return promise.then((data) => exports.QueryWhitelistedBalanceResponse.decode(new wire_1.BinaryReader(data)));
    }
    DEXSettings(request) {
        ...
        return promise.then((data) => exports.QueryDEXSettingsResponse.decode(new wire_1.BinaryReader(data)));
    }
}
